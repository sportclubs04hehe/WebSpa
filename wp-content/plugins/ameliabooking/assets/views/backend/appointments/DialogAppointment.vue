                  ...
                  <el-row class="am-selected-dropdown-item__inner" align="middle" :gutter="4" justify="left">
                    ...
                    <el-col :sm="14" class="am-align-right">
                      <div class="am-appointment-status small">
                        ...
                        >
                          <el-option
                            v-for="item in statuses.concat(getDateTime(appointment.bookingEnd) < getNowDate() ? noShowStatus : [])"
                            :key="item.value"
                            :value="item.value"
                    ...
                    <el-col :sm="10">
                      <el-form-item>
                        <div class="am-appointment-status">
                          ...
                          >
                            <el-option
                              v-for="opt in statuses.concat(getDateTime(appointment.bookingEnd) < getNowDate() ? noShowStatus : [])"
                              :key="opt.value"
                              :label="opt.label"
                              :value="opt.value"
