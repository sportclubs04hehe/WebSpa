...
<script>
  ...
  export default {
    ...
    created () {
      ...
      this.eventSpotsVisibility = this.$root.settings.customization.forms && 'parts' in this.forms.eventListForm.eventDetailsForm.itemsStatic.eventDetailsFormField ? this.forms.eventListForm.eventDetailsForm.itemsStatic.eventDetailsFormField.parts.ev_spots_number.visibility : this.defaultFormsData.eventListForm.eventFilterForm.itemsStatic.eventFilterFormField.parts.ev_spots_number.visibility
